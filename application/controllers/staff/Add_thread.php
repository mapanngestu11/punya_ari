...
class Add_thread extends CI_Controller {
	...
	function index(){
		if($this->session->userdata('akses')=='admin'){
			...
			$this->load->view('admin/add_thread',$data);
		...
		if(!empty($_FILES['filefoto']['name']))
		{
			if ($this->upload->do_upload('filefoto'))
			{
					...
					$gambar=$gbr['file_name'];
											...
											$user_id=$p['id_user'];
											$nama=$p['nama'];
											$this->m_forum->add($tittle,$forum,$category,$nama,$gambar,$status);
											echo $this->session->set_flashdata('msg','success');
											redirect('admin/add_thread');
									}else{
