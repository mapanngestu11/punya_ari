...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo site_url('admin/list_article');?>">Article List</a>
            <a class="collapse-item" href="<?php echo site_url('admin/my_article');?>">My Article List</a>
            <a class="collapse-item" href="<?php echo site_url('admin/add_article');?>">Add New Article</a>
            <a class="collapse-item" href="<?php echo site_url('admin/article_category');?>">Category</a>
        </div>
    </div>
</li>
