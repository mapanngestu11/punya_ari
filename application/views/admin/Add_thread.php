            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add New Thread</h1>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow col-md-10">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Add New Thread</h6>
                                </div>
                                <form action="<?php echo base_url().'index.php/admin/add_thread/add'?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    <label>Thread</label>
                                  <textarea name="forum" class="form-control"></textarea>
                                  </div>
