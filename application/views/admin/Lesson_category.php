       ...
       <?php include 'pages/sidebar.php';?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include 'pages/topbar_table.php';?>
                ...
                <form action="<?php echo base_url().'index.php/admin/lesson_category/add_lesson_category'?>" method="POST">
                    <div class="modal-body">
                        <label>Name</label>
                        <input type="text" name="nama" class="form-control" required>
                        <input type="hidden" name="status" value="lesson" class="form-control" required>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id_kategori;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="lesson">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/lesson_category/delete_lesson_category'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id_kategori;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="lesson">
                ...
                <div class="modal-header">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/lesson_category/update_lesson_category'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
