            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Lesson Of Learned</h1>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow col-md-10">
                                ...
                                <form action="<?php echo base_url().'index.php/admin/add_lesson/add'?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    <label>lesson</label>
                                  <textarea name="lesson" class="form-control"></textarea>
                                  </div>
                                  <button type="submit" class="btn btn-primary btn-flat" id="simpan">Save lesson</button>
                            </form>
                                </div>
                            </div>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Topic Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
