            ...
            <?php include 'pages/topbar_table.php';?>
                ...
                <div class="container-fluid">
                    ...
                    ?>                                        <tr>
                                          ...
                                          <td style="text-align:right;"><a href="<?php echo site_url('admin/my_document/get_file/'.$row->id_dokumen);?>" class="btn btn-info">Download</a></td>
                                            <td>
                                             
                                                <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $row->id_dokumen;?>"><span class="fa fa-trash"></span></a>
                                            </td>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id_dokumen;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/my_document/hapus_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                         
                           <input type="hidden" name="file" value="<?php echo $dokumen;?>">
    ...
    <div class="modal fade" id="ModalDownload<?php echo $id_dokumen;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/my_document/download'?>" >
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id_dokumen;?>"/>
