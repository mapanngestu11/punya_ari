...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        $b=$data->row_array();
    ?>
                 <form action="<?php echo base_url().'index.php/admin/verify_forum/update_forum'?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                    <label>Tittle</label>
                                    <input type="hidden" name="kode" value="<?php echo $b['id_forum'];?>">
                                  ...
                                  <div class="form-group">
                                    <label>Article</label>
                                  <textarea name="forum"  class="form-control"><?php echo $b['forum'];?></textarea>
                                  </div>
                                  <div class="form-group">
                                    <label>Status</label>
