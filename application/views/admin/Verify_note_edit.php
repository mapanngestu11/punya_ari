...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        $b=$data->row_array();
    ?>
                 <form action="<?php echo base_url().'index.php/admin/verify_note/update_note'?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                    <label>Tittle</label>
                                    <input type="hidden" name="kode" value="<?php echo $b['id_note'];?>">
