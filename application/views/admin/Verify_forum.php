            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verify Forum</h1>
                        ...
                        <div class="col-mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">My Forum</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url().'index.php/admin/verify_forum/get_edit/'.$row->id_forum;?>">Edit</span></a>
