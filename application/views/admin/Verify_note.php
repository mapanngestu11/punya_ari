            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verify note</h1>
                        ...
                        <div class="col-mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url().'index.php/admin/verify_note/get_edit/'.$row->id_note;?>">Edit</span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_note;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/my_note/delete'?>" method="post" enctype="multipart/form-data">
