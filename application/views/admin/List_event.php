            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">List Thread</h1>
                        ...
                        <div class="col-mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Day :      <?php echo $row->date_start;?>| <?php echo $row->date_end;?></h6>
                                    <h6 class="m-0 font-weight-bold text-primary">Time :      <?php echo $row->time_start;?>| <?php echo $row->time_end;?></h6>
                                </div>
