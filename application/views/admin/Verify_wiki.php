            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Verify Article</h1>
                        ...
                        <div class="col-mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url().'index.php/admin/verify_wiki/get_edit/'.$row->id_wiki;?>">Edit</span></a>
