       ...
       <?php include 'pages/sidebar.php';?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include 'pages/topbar_table.php';?>
                ...
                <form action="<?php echo base_url().'index.php/admin/event_category/add_event_category'?>" method="POST">
                    <div class="modal-body">
                        <label>Name</label>
                        <input type="text" name="nama" class="form-control" required>
                        <input type="hidden" name="status" value="event" class="form-control" required>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id_kategori;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="event">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/event_category/delete_event_category'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id_kategori;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="event">
                ...
                <div class="modal-header">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/event_category/update_event_category'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
