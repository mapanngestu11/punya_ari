            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Upload Note</h1>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow col-md-10">
                                ...
                                <form action="<?php echo base_url().'index.php/staff/upload_note/add'?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Note Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
