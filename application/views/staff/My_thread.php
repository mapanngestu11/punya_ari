                        ...
                        <div class="col-mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-warning" href="<?php echo base_url().'index.php/staff/my_thread/get_edit/'.$row->id_forum;?>">Edit</span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_forum;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/staff/my_thread/delete'?>" method="post" enctype="multipart/form-data">
