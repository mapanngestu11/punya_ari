            ...
            <?php include 'pages/topbar_table.php';?>
                ...
                <div class="container-fluid">
                    ...
                    ?>                                        <tr>
                                          ...
                                          <td style="text-align:right;"><a href="<?php echo site_url('staff/my_note/get_file/'.$row->id_note);?>" class="btn btn-info">Download</a></td>
                                            <td>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id_note;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/staff/my_note/hapus_file'?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="ModalDownload<?php echo $id_note;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'index.php/staff/my_note/download'?>" >
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id_note;?>"/>
